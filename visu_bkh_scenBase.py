# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 09:50:40 2020
...
import scenario_base as scenBase
...
def plot_mean_ben_cst_all_states_for_scenarios(
    ...
    for algo in algos:
        ...
        print("{} shape ylabel={}, {}".format(algo, ylabel, df_al[ylabel].shape))
...
if __name__ == "__main__":
    ...
    ###----    SCENARIO BASE ---> debut  --------------------------------------
    name_simu = "SCENARIO_BASE"; k_steps_args = 40
    ###----     SCENARIO BASE ---> fin-----------------------------------------
    ...
    df_arr_M_T_Ks, df_ben_cst_M_T_K, df_b0_c0_pisg_pi0_T_K, df_B_C_BB_CC_RU_M \
        = get_array_turn_df_for_t_scenBase(tuple_paths, t, k_steps_args)
