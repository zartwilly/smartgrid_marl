...
if __name__ == "__main__":
    ...
    boolean_execute = False #True #False
    boolean_execute_USE_DICT_MODE_PROFIL = True #False
    
    if boolean_get_create:
        arr_pl_M_T_vars = test_get_or_create_instance()
    if boolean_execute:
        test_execute_algos_used_Generated_instances()
    if boolean_execute_USE_DICT_MODE_PROFIL:
        test_execute_algos_used_Generated_instances_USE_DICT_MODE_PROFIL()
